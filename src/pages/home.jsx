...
function Home() {
  return (
    <main className="timeline">
      <Header />
      <TweetEditor />
      <div classNamqqe="tweets">
        <Tweet
          reply1={"57"}
          retweet={"144"}
          react={"123"}
          tweettitle={"CNN"}
          tweettitleDetail={"@CNN . 7m"}
          tweetimg={imgcnn}
          tweetText={
        ...
        <Tweet
          ...
          retweet={"36.8k"}
          react={"267.1k"}
          tweetimg={mascoteTwetterImg}
          tweettitle={"Tweeter"}
          tweettitleDetail={"@Tweeter . oct 29"}
        ...
        <Tweet
          ...
          tweetimg={mascoteTwetterImg}
          tweettitle={"Tweeter"}
          tweettitleDetail={"@Tweeter . oct 4"}
